...
namespace FeedbackApp.WebApi.Migrations
{
    ...
    [Migration("20210517095829_initial")]
            ...
            modelBuilder.Entity("FeedbackApp.WebApi.Data.Entities.Topic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TopicId = 1,
                            TopicName = "Training program & content (nội dung đào tạo)"
                        },
                        new
                        {
                            TopicId = 2,
                            TopicName = "Trainer/Coach"
                        },
                        new
                        {
                            TopicId = 3,
                            TopicName = "Cource organization (tổ chức khóa học)"
                        },
                        new
                        {
                            TopicId = 4,
